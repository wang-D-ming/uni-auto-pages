 ...
 * @LastEditTime: 2020-03-27 17:31:25
...
module.exports = function createPages(temPath = 'tempages.json') {
  ...
  let startIndex = nData.pages.findIndex(i => i.style.startHome);
  if (startIndex > -1) {
    let catchpage = nData.pages[0];
    nData.pages[0] = nData.pages[startIndex];
    nData.pages[startIndex] = catchpage;
  }
